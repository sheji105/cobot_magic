...
def forward_pass(policy_config, data, policy):
    ...
    (image_data, qpos_data,
     next_action_data, next_action_is_pad,
     action_data, action_is_pad) = (image_data.cuda(), qpos_data.cuda(),
                                    next_action_data.cuda(), next_action_is_pad.cuda(),
...
def get_arguments():
    ...
    parser.add_argument('--pretrain_ckpt_dir', action='store', type=str, help='pretrain_ckpt_dir', default='', required=False)
